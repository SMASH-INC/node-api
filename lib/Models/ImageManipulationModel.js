...
/**
 * Creates an instance of ImageManipulationModel
 */
class ImageManipulationModel extends BaseModel {
    /**
     * @constructor
    ...
    constructor(obj) {
        ...
        this.transform = this.constructor.getValue(obj.transform);
        this.moderate = this.constructor.getValue(obj.moderate);
    }
...
module.exports = ImageManipulationModel;
