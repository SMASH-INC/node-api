...
/**
 * Creates an instance of CDNPushModelResponse
 */
class CDNPushModelResponse extends BaseModel {
    /**
     * @constructor
    ...
    constructor(obj) {
        ...
        this.upload = this.constructor.getValue(obj.upload);
...
module.exports = CDNPushModelResponse;
